...
#       post favorites_url, params: { favorite: { sight_id: @favorite.sight_id, user_id: @favorite.user_id } }
#     end
#
...
#     patch favorite_url(@favorite), params: { favorite: { sight_id: @favorite.sight_id, user_id: @favorite.user_id } }
